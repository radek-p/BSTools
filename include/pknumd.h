...
void pkn_multiBandmSolveDLSQd ( int nrows, int ncols,
                                ...
                                int xpitch, double *x );
void pkn_multiBandmSolveCRLSQd ( int nrows, int ncols,
                                 const bandm_profile *aprof, const double *a,
...
void pkn_ComputeQSQTd ( int m, const double *s,   
                        int n, const double *a, const double *aa,
                        double *b );
void pkn_ComputeQTSQd ( int m, const double *s,
                        int n, const double *a, const double *aa,
                        double *b );
...
/* ///////////////////////////////////////////////////////////////////////// */
double pkn_Illinoisd ( double (*f) (double), double a, double b, double eps,
                      boolean *error );
