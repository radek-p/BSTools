...
#define xgemsg_2DWIN_TGSELECT_POINTS         0x120
#define xgemsg_2DWIN_SPECIAL_SELECT          0x121
#define xgemsg_2DWIN_SPECIAL_UNSELECT        0x122
#define xgemsg_2DWIN_CHANGE_TRANS            0x123
#define xgemsg_2DWIN_SAVE_POINTS             0x124
#define xgemsg_2DWIN_TRANSFORM_POINTS        0x125
#define xgemsg_2DWIN_TRANSFORM_SPECIAL       0x126
#define xgemsg_2DWIN_FIND_REFBBOX            0x127
#define xgemsg_2DWIN_UNDO                    0x128
#define xgemsg_2DWIN_KEY                     0x129
#define xgemsg_2DWIN_ERROR                   0x12A

#define xgemsg_3DWIN_RESIZE                  0x12B
#define xgemsg_3DWIN_PROJCHANGE              0x12C
#define xgemsg_3DWIN_PICK_POINT              0x12D
#define xgemsg_3DWIN_MOVE_POINT              0x12E
#define xgemsg_3DWIN_SELECT_POINTS           0x12F
#define xgemsg_3DWIN_UNSELECT_POINTS         0x130
#define xgemsg_3DWIN_TGSELECT_POINTS         0x131
#define xgemsg_3DWIN_SPECIAL_SELECT          0x132
#define xgemsg_3DWIN_SPECIAL_UNSELECT        0x133
#define xgemsg_3DWIN_CHANGE_TRANS            0x134
#define xgemsg_3DWIN_SAVE_POINTS             0x135
#define xgemsg_3DWIN_TRANSFORM_POINTS        0x136
#define xgemsg_3DWIN_TRANSFORM_SPECIAL       0x137
#define xgemsg_3DWIN_FIND_REFBBOX            0x138
#define xgemsg_3DWIN_UNDO                    0x139
#define xgemsg_3DWIN_KEY                     0x13A
#define xgemsg_3DWIN_ERROR                   0x13B

#define xgemsg_KNOTWIN_CHANGE_KNOT           0x13C
#define xgemsg_KNOTWIN_INSERT_KNOT           0x13D
#define xgemsg_KNOTWIN_REMOVE_KNOT           0x13E
#define xgemsg_KNOTWIN_CHANGE_ALTKNOT        0x13F
#define xgemsg_KNOTWIN_INSERT_ALTKNOT        0x140
#define xgemsg_KNOTWIN_REMOVE_ALTKNOT        0x141
#define xgemsg_KNOTWIN_MCLICK                0x142
#define xgemsg_KNOTWIN_MMOVE                 0x143
#define xgemsg_KNOTWIN_CHANGE_MAPPING        0x144
#define xgemsg_KNOTWIN_ERROR                 0x145

#define xgemsg_T2KNOTWIN_RESIZE              0x146
#define xgemsg_T2KNOTWIN_PROJCHANGE          0x147
#define xgemsg_T2KNOTWIN_CHANGE_KNOT_U       0x148
#define xgemsg_T2KNOTWIN_CHANGE_KNOT_V       0x149
#define xgemsg_T2KNOTWIN_INSERT_KNOT_U       0x14A
#define xgemsg_T2KNOTWIN_INSERT_KNOT_V       0x14B
#define xgemsg_T2KNOTWIN_REMOVE_KNOT_U       0x14C
#define xgemsg_T2KNOTWIN_REMOVE_KNOT_V       0x14D
#define xgemsg_T2KNOTWIN_CHANGE_ALTKNOT_U    0x14E
#define xgemsg_T2KNOTWIN_CHANGE_ALTKNOT_V    0x14F
#define xgemsg_T2KNOTWIN_INSERT_ALTKNOT_U    0x150
#define xgemsg_T2KNOTWIN_INSERT_ALTKNOT_V    0x151
#define xgemsg_T2KNOTWIN_REMOVE_ALTKNOT_U    0x152
#define xgemsg_T2KNOTWIN_REMOVE_ALTKNOT_V    0x153
#define xgemsg_T2KNOTWIN_SELECT_POINTS       0x154
#define xgemsg_T2KNOTWIN_UNSELECT_POINTS     0x155
#define xgemsg_T2KNOTWIN_TGSELECT_POINTS     0x156
#define xgemsg_T2KNOTWIN_CHANGE_MAPPING      0x157
#define xgemsg_T2KNOTWIN_ERROR               0x158

/* message sent when popups are removed */
#define xgemsg_POPUP_REMOVED                 0x159
#define xgemsg_POPUPS_REMOVED                0x15A

/* message sent after an error, warning or info message has been dismissed */
#define xgemsg_USER_MESSAGE_DISMISSED        0x15B

/* message sent to the application by itself, to be delivered */
/* when there is nothing else to do */
#define xgemsg_IDLE_COMMAND                  0x15C

/* message sent to the application by a child process */
#define xgemsg_CHILD_MESSAGE                 0x15D
/* message sent after the child process has been terminated */
#define xgemsg_CHILD_FAILURE                 0x15E
...
#define xgestate_2DWIN_TGSELECTING           23
#define xgestate_2DWIN_MOVING_GEOM_WIDGET    24
#define xgestate_2DWIN_USING_GEOM_WIDGET     25
#define xgestate_2DWIN_ALTUSING_GEOM_WIDGET  26
#define xgestate_2DWIN_USING_SPECIAL_WIDGET  27
#define xgestate_3DWIN_MOVINGPOINT           28
#define xgestate_3DWIN_PARPANNING            29
#define xgestate_3DWIN_PARZOOMING            30
#define xgestate_3DWIN_TURNING_VIEWER        31
#define xgestate_3DWIN_PANNING               32
#define xgestate_3DWIN_ZOOMING               33
#define xgestate_3DWIN_SELECTING             34
#define xgestate_3DWIN_UNSELECTING           35
#define xgestate_3DWIN_TGSELECTING           36
#define xgestate_3DWIN_MOVING_GEOM_WIDGET    37
#define xgestate_3DWIN_USING_GEOM_WIDGET     38
#define xgestate_3DWIN_ALTUSING_GEOM_WIDGET  39
#define xgestate_3DWIN_USING_SPECIAL_WIDGET  40
#define xgestate_KNOTWIN_MOVINGKNOT          41
#define xgestate_KNOTWIN_PANNING             42
#define xgestate_KNOTWIN_ZOOMING             43
#define xgestate_T2KNOTWIN_MOVINGKNOT_U      44
#define xgestate_T2KNOTWIN_MOVINGKNOT_V      45
#define xgestate_T2KNOTWIN_MOVING_POINT      46
#define xgestate_T2KNOTWIN_PANNING           47
#define xgestate_T2KNOTWIN_ZOOMING           48
#define xgestate_T2KNOTWIN_SELECTING         49
#define xgestate_T2KNOTWIN_UNSELECTING       50
#define xgestate_T2KNOTWIN_TGSELECTING       51
#define xgestate_LISTBOX_PICKING             52
