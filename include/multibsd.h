...
void mbs_multiBCDegElevd ( int ncurves, int spdimen,
...
void mbs_BCDegElevPd ( int spdimen,
...
void mbs_multiBSDegElevd ( int ncurves, int spdimen,
...
void mbs_multiBSCubicInterpd ( int lastinterpknot, double *interpknots,
