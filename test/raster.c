...
char fn1[] = "rasterbc.ps";
char fn2[] = "rasterbs.ps";

/* ///////////////////////////////////////////////////////////////////////// */
point2f bc2[4] = {{100.0,50.0},{500.0,250.0},
                 {0.0,250.0},{400.0,50.0}};
point3f bc3[4] = {{100.0,200.0,1.0},{1000.0,420.0,2.0},
                 {0.0,450.0,1.0},{400.0,100.0,1.0}};
point2f bs2[7] = {{100.0,20.0},{250.0,50.0},{500.0,200.0},{250.0,250.0},
                  {200.0,100.0},{300.0,150.0},{400.0,20.0}};
point3f bs3[7] = {{100.0,70.0,1.0},{1000.0,400.0,4.0},{250.0,125.0,0.5},
                  {250.0,300.0,1.0},
                  {400.0,300.0,2.0},{150.0,100.0,0.5},{400.0,70.0,1.0}};
float u[11] = {0.0,0.0,0.0,0.0,0.3,0.5,0.7,1.0,1.0,1.0,1.0};
...
int main ()
{
  ...
  ps_Set_Gray ( 0.25 );
  mbs_RasterizeBC2f ( 3, bc2, OutputPixels, true );
  ps_Set_Gray ( 0.56 );
  mbs_RasterizeBC2Rf ( 3, bc3, OutputPixels, true );
  ps_CloseFile ();
  ...
  ps_Write_Command ( "} bind def" );
  ps_Set_Gray ( 0.25 );
  mbs_RasterizeBS2f ( 3, 10, u, bs2, OutputPixels, true );
  ps_Set_Gray ( 0.56 );
  mbs_RasterizeBS2Rf ( 3, 10, u, bs3, OutputPixels, true );
  ps_CloseFile ();
