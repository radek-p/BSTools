...
void DrawRBezTreeVertexDivision ( RBezPatchTreeVertexf *vertex,
...
void DrawRBezTree ( RBezPatchTreef *tree, float w, float x, float y )
{
  float h;
...
int main ( void )
{
  ...
  times ( &start );
  tree = rbez_NewRBSPatchTreef ( 0, n, lknu, knots_u, m, lknv, knots_v,
                                 lknv-m, cpoints );
  RayTrace ();
