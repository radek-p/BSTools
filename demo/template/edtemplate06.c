...
void ResizeWinStatus ( int win )
{
  ...
  if ( win == win0 ) {
    ...
    if ( status_1_sw ) {
      ...
      knwind->y = (short)(xge_current_height-16-knwind->h);
    }
    else {
      status1->data0 = txtNULL;
      w = 110;
      h = (short)(xge_current_height-20);
      knwind->y = (short)(xge_current_height-knwind->h);
    }
    domwind.er->msgproc ( domwind.er, xgemsg_RESIZE, 0,
                          (short)(xge_current_width-110),
                          (short)(h-knwind->h-4) );
    knwind->msgproc ( knwind, xgemsg_RESIZE, 0,
                      (short)(xge_current_width-110), knwind->h );
