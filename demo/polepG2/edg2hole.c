...
static char *InfoMsg[8] =
  { "Filling a polygonal hole in a piecewise bicubic surface with curvature",
    "continuity, by solving the triharmonic equation.",
    "",
...
void init_edwin ( int argc, char *argv[] )
{
  ...
  SetupEdRect ( menurect1b,  4, 103, 16, 16, 60, 145, SwitchMsg, DrawSwitch );
  SetupEdRect ( menurect1b,  5, 104, 16, 16, 80, 145, SwitchMsg, DrawSwitch );
  ...
  SetupEdRect ( menurect1b,  8, 107, 16, 16, 60, 165, SwitchMsg, DrawSwitch );
  SetupEdRect ( menurect1b,  9, 108, 16, 16, 80, 165, SwitchMsg, DrawSwitch );
  ...
  SetupEdRect ( menurect1b, 12, 111, 16, 16, 60, 185, SwitchMsg, DrawSwitch );
  SetupEdRect ( menurect1b, 13, 112, 16, 16, 80, 185, SwitchMsg, DrawSwitch );
  ...
  SetupEdRect ( menurect1b, 16, 115, 16, 16, 60, 205, SwitchMsg, DrawSwitch );
  SetupEdRect ( menurect1b, 17, 116, 16, 16, 80, 205, SwitchMsg, DrawSwitch );
  ...
  SetupEdRect ( menurect1b, 20, 119, 16, 16, 60, 225, SwitchMsg, DrawSwitch );
  SetupEdRect ( menurect1b, 21, 120, 16, 16, 80, 225, SwitchMsg, DrawSwitch );
  ...
  SetupEdRect ( menurect1b, 24, 123, 16, 16, 60, 245, SwitchMsg, DrawSwitch );
  SetupEdRect ( menurect1b, 25, 124, 16, 16, 80, 245, SwitchMsg, DrawSwitch );
  ...
  SetupEdRect ( menurect1b, 28, 127, 16, 16, 60, 265, SwitchMsg, DrawSwitch );
  SetupEdRect ( menurect1b, 29, 128, 16, 16, 80, 265, SwitchMsg, DrawSwitch );
  ...
  SetupEdRect ( menurect1b, 32, 131, 16, 16, 60, 285, SwitchMsg, DrawSwitch );
  SetupEdRect ( menurect1b, 33, 132, 16, 16, 80, 285, SwitchMsg, DrawSwitch );
