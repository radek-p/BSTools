...
static void OutPixels ( const xpoint *buf, int n )
{
  XDrawPoints ( thedisplay, thepixmap, thegc,
...
{
  if ( i == 0 || i == dd )
    XSetForeground ( thedisplay, thegc, colour1 );
  else if ( i == 1 )
    XSetForeground ( thedisplay, thegc, colour2 );
} /*SetForeground*/
...
static boolean DrawArcBC3a ( int degree, const point3f *cpoints )
{
  ...
  result = mbs_RasterizeBC2Rf ( degree, cp, OutPixels, true );
...
static boolean DrawArcBC2 ( int degree, const point2f *cpoints )
{
  return mbs_RasterizeBC2f ( degree, cpoints, OutPixels, true );
} /*DrawArcBC2*/
                      ...
                      int dd1, int dd2, int colour1, int colour2 )
{
  ...
  for ( i = 0; i <= dd1; i++ ) {
    ...
    mbs_ClipBC2f ( 4, pplanes, m, cp, DrawArcBC2 );
  }
  ...
  for ( i = 0; i <= dd2; i++ ) {
    ...
    mbs_ClipBC2f ( 4, pplanes, n, cp, DrawArcBC2 );
  }
                      ...
                      int dd1, int dd2, int colour1, int colour2 )
{
  ...
  for ( i = 0; i <= dd1; i++ ) {
    ...
    if ( t >= u0 && t <= u1 ) {
      ...
      mbs_ClipBC2f ( 4, pplanes, m, cq, DrawArcBC2 );
    }
  }
  ...
  for ( i = 0; i <= dd2; i++ ) {
    ...
    if ( t >= v0 && t <= v1 ) {
      ...
      mbs_ClipBC2f ( 4, pplanes, n, cq, DrawArcBC2 );
    }
  }
  pkv_SetScratchMemTop ( sp );
} /*DrawBezPatch2a*/
