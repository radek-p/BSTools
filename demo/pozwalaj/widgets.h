...
#define swM1BSC_DOMAIN_COORD           (SIDEMENU1_BSC+6)
#define swM1BSC_DOMAIN_PANZOOM         (SIDEMENU1_BSC+7)

#define swM1BSC_VIEW_CURVE             (SIDEMENU1_BSC+8)
#define swM1BSC_VIEW_CPOLY             (SIDEMENU1_BSC+9)
#define swM1BSC_VIEW_BPOLY            (SIDEMENU1_BSC+10)
#define swM1BSC_VIEW_CURVATURE        (SIDEMENU1_BSC+11)
#define slM1BSC_SCALE_CURVATURE       (SIDEMENU1_BSC+12)
#define swM1BSC_VIEW_TORSION          (SIDEMENU1_BSC+13)
#define slM1BSC_SCALE_TORSION         (SIDEMENU1_BSC+14)
#define intwM1BSC_GRAPH_DENSITY       (SIDEMENU1_BSC+15)
#define btnM1BSC_COLOUR               (SIDEMENU1_BSC+16)
#define slM1BSC_PIPE_DIAMETER         (SIDEMENU1_BSC+17)

#define swM1MSC_MENGERC               (SIDEMENU1_BSC+18)
#define slM1MSC_MENGERC_EXP           (SIDEMENU1_BSC+19)
#define slM1MSC_MENGERC_P1            (SIDEMENU1_BSC+20) /* this and next 4 */
#define slM1MSC_MENGERC_P2            (SIDEMENU1_BSC+21) /* must be consecutive */
#define slM1MSC_MENGERC_P3            (SIDEMENU1_BSC+22)
#define slM1MSC_MENGERC_P4            (SIDEMENU1_BSC+23)
#define slM1MSC_MENGERC_P5            (SIDEMENU1_BSC+24)
#define intwM1BSC_MENGERC_QKN         (SIDEMENU1_BSC+25)
#define intwM1BSC_MENGERC_POPT        (SIDEMENU1_BSC+26)
#define intwM1BSC_MENGERC_MAXIT       (SIDEMENU1_BSC+27)
#define intwM1BSC_MENGERC_NPTHREADS   (SIDEMENU1_BSC+28)
#define swM1BSC_MENGERC_LOG           (SIDEMENU1_BSC+29)
#define btnM1BSC_MENGERC_OPTIMIZE     (SIDEMENU1_BSC+30)
...
#define swM1BSP_DOMAIN_COORD          (SIDEMENU1_BSP+10)
#define swM1BSP_DOMAIN_PANZOOM        (SIDEMENU1_BSP+11)

#define swM1BSP_VIEW_SURF             (SIDEMENU1_BSP+12)
#define swM1BSP_VIEW_CNET             (SIDEMENU1_BSP+13)
#define intwM1BSP_DENSITY_U           (SIDEMENU1_BSP+14)
#define intwM1BSP_DENSITY_V           (SIDEMENU1_BSP+15)
#define btnM1BSP_COLOUR               (SIDEMENU1_BSP+16)

#define swM1BSP_BLENDING_CLAMPED      (SIDEMENU1_BSP+17)
#define swM1BSP_NHARMONIC             (SIDEMENU1_BSP+18)
#define btnM1BSP_PRETRANSFORMATION    (SIDEMENU1_BSP+19)
#define swM1BSP_BLENDING_ENTIRE       (SIDEMENU1_BSP+20)
#define intwM1BSP_G1BLENDING_UMIN     (SIDEMENU1_BSP+21)
#define intwM1BSP_G1BLENDING_UMAX     (SIDEMENU1_BSP+22)
#define intwM1BSP_G1BLENDING_VMIN     (SIDEMENU1_BSP+23)
#define intwM1BSP_G1BLENDING_VMAX     (SIDEMENU1_BSP+24)
#define intwM1BSP_G2BLENDING_UMIN     (SIDEMENU1_BSP+25)
#define intwM1BSP_G2BLENDING_UMAX     (SIDEMENU1_BSP+26)
#define intwM1BSP_G2BLENDING_VMIN     (SIDEMENU1_BSP+27)
#define intwM1BSP_G2BLENDING_VMAX     (SIDEMENU1_BSP+28)
#define slM1BSP_BLENDING_CPARAM       (SIDEMENU1_BSP+29)
#define intwM1BSP_NKN1                (SIDEMENU1_BSP+30)
#define intwM1BSP_NKN2                (SIDEMENU1_BSP+31)
#define intwM1BSP_MAXIT               (SIDEMENU1_BSP+32)
#define btnM1BSP_BLENDING_OPTIMIZE    (SIDEMENU1_BSP+33)
#define btnM1BSP_BLENDING_REFINE      (SIDEMENU1_BSP+34)

#define swM1BSP_SPRODUCT_EQUATOR      (SIDEMENU1_BSP+35)
#define textedM1BSP_SPRODUCT_EQNAME   (SIDEMENU1_BSP+36)
#define intWM1BSP_SPRODUCT_EQDEG      (SIDEMENU1_BSP+37)
#define swM1BSP_SPRODUCT_EQRATIONAL   (SIDEMENU1_BSP+38)
#define swM1BSP_SPRODUCT_EQCLOSED     (SIDEMENU1_BSP+39)
#define swM1BSP_SPRODUCT_EQUNIFORM    (SIDEMENU1_BSP+40)
#define swM1BSP_SPRODUCT_MERIDIAN     (SIDEMENU1_BSP+41)
#define textedM1BSP_SPRODUCT_MERNAME  (SIDEMENU1_BSP+42)
#define intWM1BSP_SPRODUCT_MERDEG     (SIDEMENU1_BSP+43)
#define swM1BSP_SPRODUCT_MERRATIONAL  (SIDEMENU1_BSP+44)
#define swM1BSP_SPRODUCT_MERCLOSED    (SIDEMENU1_BSP+45)
#define swM1BSP_SPRODUCT_MERUNIFORM   (SIDEMENU1_BSP+46)
...
#define intwM1BSM_EDGE0               (SIDEMENU1_BSM+16)
#define intwM1BSM_EDGE1               (SIDEMENU1_BSM+17)
#define btnM1BSM_SHRINK_EDGE          (SIDEMENU1_BSM+18)
#define btnM1BSM_CONTRACT_EDGE        (SIDEMENU1_BSM+19)
#define btnM1BSM_GLUE_EDGES           (SIDEMENU1_BSM+20)
#define btnM1BSM_GLUE_EDGE_LOOPS      (SIDEMENU1_BSM+21)
#define btnM1BSM_SEAL_HOLE            (SIDEMENU1_BSM+22)
#define intwM1BSM_FACET0              (SIDEMENU1_BSM+23)
#define intwM1BSM_FACET1              (SIDEMENU1_BSM+24)
#define btnM1BSM_REMOVE_FACET         (SIDEMENU1_BSM+25)
#define btnM1BSM_DOUBLE_FAC_EDGES     (SIDEMENU1_BSM+26)

#define swM1BSM_VIEW_SURF             (SIDEMENU1_BSM+27)
#define swM1BSM_VIEW_CNET             (SIDEMENU1_BSM+28)
#define intwM1BSM_DENSITY             (SIDEMENU1_BSM+29)
#define swM1BSM_VIEW_SPECIAL          (SIDEMENU1_BSM+30)
#define swM1BSM_HOLE_FILLING          (SIDEMENU1_BSM+31)
#define btnM1BSM_COLOUR               (SIDEMENU1_BSM+32)

#define intwM1BSM_DATA_KGON           (SIDEMENU1_BSM+33)
#define btnM1BSM_DATA_KGON            (SIDEMENU1_BSM+34)
#define btnM1BSM_DATA_TETRAHEDRON     (SIDEMENU1_BSM+35)
#define btnM1BSM_DATA_CUBE            (SIDEMENU1_BSM+36)
#define btnM1BSM_DATA_DODECAHEDRON    (SIDEMENU1_BSM+37)
#define intwM1BSM_DATA_KPRISM         (SIDEMENU1_BSM+38)
#define btnM1BSM_DATA_KPRISM          (SIDEMENU1_BSM+39)
#define swM1BSM_DATA_REPLACE          (SIDEMENU1_BSM+40)
#define swM1BSM_DATA_ADD              (SIDEMENU1_BSM+41)

#define scwM1BSM_OCONTENTS            (SIDEMENU1_BSM+42)
#define scwM1BSM_OSCROLL              (SIDEMENU1_BSM+43)   
#define swM1BSM_SUBDIVISION           (SIDEMENU1_BSM+44)
#define swM1BSM_BLENDING              (SIDEMENU1_BSM+45)
#define swM1BSM_G1                    (SIDEMENU1_BSM+46)
#define swM1BSM_G2                    (SIDEMENU1_BSM+47)
#define swM1BSM_G1_QUASI_G2           (SIDEMENU1_BSM+48)
#define slM1BSM_G1Q2_PARAM            (SIDEMENU1_BSM+49)
#define swM1BSM_HOLEFILL_COONS        (SIDEMENU1_BSM+50)
#define swM1BSM_HOLEFILL_BEZIER       (SIDEMENU1_BSM+51)
#define btnM1BSM_PRETRANSFORMATION    (SIDEMENU1_BSM+52)
#define slM1BSM_BLENDING_CPARAM       (SIDEMENU1_BSM+53)
#define swM1BSM_BLENDING_CONSTRAINTS  (SIDEMENU1_BSM+54)
#define intwM1BSM_NKN1                (SIDEMENU1_BSM+55)
#define intwM1BSM_NKN2                (SIDEMENU1_BSM+56)
#define intwM1BSM_MAXIT               (SIDEMENU1_BSM+57)
#define intwM1BSM_NLEVELS             (SIDEMENU1_BSM+58)
#define btnM1SUGGESTLEVELS            (SIDEMENU1_BSM+59)
#define btnM1SUGGESTBLOCKS            (SIDEMENU1_BSM+60)
#define intwM1BSM_NBLOCKS             (SIDEMENU1_BSM+61)
#define swM1BSM_SHAPE_ONLY            (SIDEMENU1_BSM+62)
#define swM1BSM_ALT_MULTILEVEL        (SIDEMENU1_BSM+63)
#define swM1BSM_COARSE_PRECOND        (SIDEMENU1_BSM+64)
#define textedM1BSM_COARSE_NAME       (SIDEMENU1_BSM+65)
#define intwM1BSM_NPTHREADS           (SIDEMENU1_BSM+66)
#define btnM1BSM_BLENDING_OPTIMIZE    (SIDEMENU1_BSM+67)
#define swM1BSM_LOG_IT                (SIDEMENU1_BSM+68)
#define btnM1BSM_OPTIMIZE_SPECIALS    (SIDEMENU1_BSM+69)
