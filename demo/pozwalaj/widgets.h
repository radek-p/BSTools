...
#define intwM1BSM_FACET0              (SIDEMENU1_BSM+21)
#define intwM1BSM_FACET1              (SIDEMENU1_BSM+22)
#define btnM1BSM_REMOVE_FACET         (SIDEMENU1_BSM+23)
#define btnM1BSM_DOUBLE_FAC_EDGES     (SIDEMENU1_BSM+24)

#define swM1BSM_VIEW_SURF             (SIDEMENU1_BSM+25)
#define swM1BSM_VIEW_CNET             (SIDEMENU1_BSM+26)
#define intwM1BSM_DENSITY             (SIDEMENU1_BSM+27)
#define swM1BSM_VIEW_SPECIAL          (SIDEMENU1_BSM+28)
#define swM1BSM_HOLE_FILLING          (SIDEMENU1_BSM+29)
#define btnM1BSM_COLOUR               (SIDEMENU1_BSM+30)

#define intwM1BSM_DATA_KGON           (SIDEMENU1_BSM+31)
#define btnM1BSM_DATA_KGON            (SIDEMENU1_BSM+32)
#define btnM1BSM_DATA_TETRAHEDRON     (SIDEMENU1_BSM+33)
#define btnM1BSM_DATA_CUBE            (SIDEMENU1_BSM+34)
#define btnM1BSM_DATA_DODECAHEDRON    (SIDEMENU1_BSM+35)
#define intwM1BSM_DATA_KPRISM         (SIDEMENU1_BSM+36)
#define btnM1BSM_DATA_KPRISM          (SIDEMENU1_BSM+37)
#define swM1BSM_DATA_REPLACE          (SIDEMENU1_BSM+38)
#define swM1BSM_DATA_ADD              (SIDEMENU1_BSM+39)

#define scwM1BSM_OCONTENTS            (SIDEMENU1_BSM+40)
#define scwM1BSM_OSCROLL              (SIDEMENU1_BSM+41)   
#define swM1BSM_SUBDIVISION           (SIDEMENU1_BSM+42)
#define swM1BSM_BLENDING              (SIDEMENU1_BSM+43)
#define swM1BSM_G1                    (SIDEMENU1_BSM+44)
#define swM1BSM_G2                    (SIDEMENU1_BSM+45)
#define swM1BSM_G1_QUASI_G2           (SIDEMENU1_BSM+46)
#define slM1BSM_G1Q2_PARAM            (SIDEMENU1_BSM+47)
#define swM1BSM_HOLEFILL_COONS        (SIDEMENU1_BSM+48)
#define swM1BSM_HOLEFILL_BEZIER       (SIDEMENU1_BSM+49)
#define btnM1BSM_PRETRANSFORMATION    (SIDEMENU1_BSM+50)
#define slM1BSM_BLENDING_CPARAM       (SIDEMENU1_BSM+51)
#define swM1BSM_BLENDING_CONSTRAINTS  (SIDEMENU1_BSM+52)
#define intwM1BSM_NKN1                (SIDEMENU1_BSM+53)
#define intwM1BSM_NKN2                (SIDEMENU1_BSM+54)
#define intwM1BSM_MAXIT               (SIDEMENU1_BSM+55)
#define intwM1BSM_NLEVELS             (SIDEMENU1_BSM+56)
#define btnM1SUGGESTLEVELS            (SIDEMENU1_BSM+57)
#define btnM1SUGGESTBLOCKS            (SIDEMENU1_BSM+58)
#define intwM1BSM_NBLOCKS             (SIDEMENU1_BSM+59)
#define swM1BSM_SHAPE_ONLY            (SIDEMENU1_BSM+60)
#define swM1BSM_ALT_MULTILEVEL        (SIDEMENU1_BSM+61)
#define swM1BSM_COARSE_PRECOND        (SIDEMENU1_BSM+62)
#define textedM1BSM_COARSE_NAME       (SIDEMENU1_BSM+63)
#define intwM1BSM_NPTHREADS           (SIDEMENU1_BSM+64)
#define btnM1BSM_BLENDING_OPTIMIZE    (SIDEMENU1_BSM+65)
#define swM1BSM_LOG_IT                (SIDEMENU1_BSM+66)
#define btnM1BSM_OPTIMIZE_SPECIALS    (SIDEMENU1_BSM+67)
