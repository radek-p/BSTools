               ...
               float *pv )
{
  ...
  mbs_multiMultBezCf ( 1, G1_BF01DEG, 0, b1, spdimen, 1, G1_CROSS00DEG-1, 0, r0u,
                       &deg1, 0, aux1 );
  mbs_multiMultBezCf ( 1, G1_CG01DEG, 0, c1, spdimen, 1, G1_CROSS00DEG-1, 0, r0s,
                       &deg2, 0, aux2 );
               ...
               float *pv )
{
  ...
  mbs_multiFindBezDerivativef ( 3, 1, spdimen, 0, r0, 0, r0u );
        ...
        /* compute pv = b1*ru + c1*rs */
  mbs_multiMultBezCf ( 1, G1_BF11DEG, 0, b1, spdimen, 1, 2, 0, r0u,
                       &deg1, 0, aux1 );
  mbs_multiMultBezCf ( 1, G1_CG11DEG, 0, c1, spdimen, 1, 3, 0, r0s,
                       &deg2, 0, pv );
