...
default:   /* splines */
  ...
  mbs_multiInterp2knHermiteBezf ( hole_k, 1, G1_CROSS00DEG,
                    3, 5, br0bc, 2, 5, &br0bc[3], G1_CROSS00DEG+1, br0 );
  mbs_multiInterp2knHermiteBezf ( hole_k, 1, G1_CROSS00DEG-1,
                              ...
                              float *bezfc, float *fcomc, float *fcomcd )
{
  ...
  mbs_multiInterp2knHermiteBezf ( hole_k, 1, G1_CROSS00DEG,
     3, (G1H_OMCDEG+1), (float*)fcomcbc, 2, (G1H_OMCDEG+1), (float*)&fcomcbc[3], (G1H_OMCDEG+1), (float*)fcomc );
  mbs_multiInterp2knHermiteBezf ( hole_k, 1, G1_CROSS00DEG-1,
     2, G1H_OMCDEG, (float*)fcomcbcd, 2, G1H_OMCDEG, (float*)&fcomcbcd[2], G1H_OMCDEG, (float*)fcomcd );
