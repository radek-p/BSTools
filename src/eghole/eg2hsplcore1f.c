...
case 0:   /* nonzero is r0 and its derivatives, r0u, r0uu */
    ...
    lkn1 = size;
    if ( !mbs_multiMultBSCf ( 1, G2_BF01DEG, 2*G2_BF01DEG+1,
    ...
    mbs_multiAdjustBSCRepf ( 1, 1, deg1, lkn1, kn1, 0, aux1,
      ...
      /* = b2*r0u + b1b1*r0uu */
    lkn1 = size;
    if ( !mbs_multiMultBSCf ( 1, G2_BF02DEG, 2*G2_BF02DEG+1,
                        &knb[G2H_FINALDEG-G2_BF02DEG],
                        0, b2, 1, 1, G2H_OMCDEG-1, lknr-2, &knr[1], 0, r0u,
                        &deg1, &lkn1, kn1, 0, aux1 ) )
      goto failure;
    lkn2 = size;
    if ( !mbs_multiMultBSCf ( 1, 2*G2_BF01DEG, 4*G2_BF01DEG+1,
...
case 1:   /* nonzero is r0s and its derivative, r0us */
    ...
    lkn1 = size;
    if ( !mbs_multiMultBSCf ( 1, G2_CG01DEG, 2*G2_CG01DEG+1,
    ...
    mbs_multiAdjustBSCRepf ( 1, 1, deg1, lkn1, kn1, 0, aux1,
      ...
      /* = c2*r0s + twob1c1*r0us */
    lkn1 = size;
    if ( !mbs_multiMultBSCf ( 1, G2_CG02DEG, 2*G2_CG02DEG+1,
                        &knb[G2H_FINALDEG-G2_CG02DEG],
                        0, c2, 1, 1, G2H_OMCDEG-1, lknr-2, &knr[1], 0, r0s,
                        &deg1, &lkn1, kn1, 0, aux1 ) )
      goto failure;
    lkn2 = size;
    if ( !mbs_multiMultBSCf ( 1, G2_BF01DEG+G2_CG01DEG, 2*(G2_BF01DEG+G2_CG01DEG)+1,
...
case 2:   /* nonzero is r0ss */
    ...
    memset ( pv, 0, (lknpv-degpv)*sizeof(float) );
      ...
      /* = c1c1*r0ss */
    lkn1 = size;
    if ( !mbs_multiMultBSCf ( 1, 2*G2_CG01DEG, 4*G2_CG01DEG+1,
