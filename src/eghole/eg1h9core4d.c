...
static boolean FindJFunctionsDid (
     const vector2d *omcbci, const vector2d *omcbcdi,
     const vector2d *omcbcj, const vector2d *omcbcdj,
     const vector2d *surrpcbci, const vector2d *surrpcbcj,
...
#define r1us1   surrpcbcj[9+4]
  ...
  void     *sp;
  double   b010, b01d0, c010, c01d0, b011, b01d1, c011, c01d1,
  ...
  SolveCompatibilityEq2ad (
        ...
        b010, c010, f010, g010, &b01d0, c01d0, &f01d0, g01d0 );
          ...
          /* hence their derivatives are the following: */
  b01d1 = (double)(2.0*(b011-b010)-b01d0);
  f01d1 = (double)(2.0*(f011-f010)-f01d0);
  ...
  SolveCompatibilityEq2dd ( &q0v1, &q0t1, &q0vt1, &r1u0, &r1s0, &r1us0,
                            g011, c110, f01d1, g01d1, &b11d0, &c11d0 );
  SolveCompatibilityEq2dd ( &r0u1, &r0s1, &r0us1, &q1v0, &q1t0, &q1vt0,
                            c011, g110, b01d1, c01d1, &f11d0, &g11d0 );

          /* by assumption, c11 and g11 are polynomials of degree 2, */
          /* hence their derivatives are the following: */
  c11d1  = (double)(2.0*(c111-c110)-c11d0);
  g11d1  = (double)(2.0*(g111-g110)-g11d0);

          /* the derivatives of b11 and f11 at 1 must satisfy the */
          /* mixed partial derivatives compatibility condition at (1,1) */
  SolveCompatibilityEq2cd ( &r1u1, &r1s1, &r1us1, &q1v1, &q1t1, &q1vt1,
  ...
  b11[0] = b110;  b11[1] = (double)(b110+b11d0/3.0);
  b11[2] = (double)(b111-b11d1/3.0);  b11[3] = b111;
  c11[0] = c110;  c11[1] = (double)(c110+0.5*c11d0);  c11[2] = c111;
  f11[0] = f110;  f11[1] = (double)(f110+f11d0/3.0);
  f11[2] = (double)(f111-f11d1/3.0);  f11[3] = f111;
  g11[0] = g110;  g11[1] = (double)(g110+0.5*g11d0);  g11[2] = g111;
...
static boolean FindJFunctionsd ( GHoleDomaind *domain )
{
  ...
  int      hole_k;
  int      i, j;
  vector2d *omcbc, *omcbcd, *surrpcbc;
  ...
  privateG1->jfunc = malloc ( hole_k*i*sizeof(double) );
  if ( !privateG1->jfunc ) {
  ...
  for ( i = 0; i < hole_k; i++ ) {
    j = (i+1) % hole_k;
    if ( !FindJFunctionsDid ( &omcbc[(G1H_OMCDEG+1)*i], &omcbcd[G1H_OMCDEG*i],
  ...
  if ( !_g1h_VerifyJunctionFunctionsd ( domain ) ) {
