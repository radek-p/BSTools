...
static boolean FindJFunctionsDid (
     const vector2d *omcbci, const vector2d *omcbcdi, const vector2d *omcbcddi,
     const vector2d *omcbcj, const vector2d *omcbcdj, const vector2d *omcbcddj,
     const vector2d *surrpcbci,
     const vector2d *surrpcbcj,
     double *b01, double *c01, double *f01, double *g01,
     double *b11, double *c11, double *f11, double *g11,
     double *b02, double *c02, double *f02, double *g02,
     double *b12, double *c12, double *f12, double *g12 )
{
...
#define r1uuss1 surrpcbcj[9+8]
  ...
  void     *sp;
  double   b010, b01d0, b01dd0, c010, c01d0, c01dd0,
  ...
  SolveCompatibilityEq1d ( &r0u0, &r0s0, &q0v0, &b010, &c010 );
  SolveCompatibilityEq1d ( &q0v0, &q0t0, &r0u0, &f010, &g010 );
          /* function values at (0,1) */
  SolveCompatibilityEq1d ( &r1u0, &r1s0, &q0v1, &b110, &c110 );
  SolveCompatibilityEq1d ( &q0v1, &q0t1, &r1u0, &f011, &g011 );
  b110 = f011 = 0.0;
          /* function values at (1,0) */
  SolveCompatibilityEq1d ( &r0u1, &r0s1, &q1v0, &b011, &c011 );
  SolveCompatibilityEq1d ( &q1v0, &q1t0, &r0u1, &f110, &g110 );
  b011 = f110 = 0.0;
          /* function values at (1,1) */
  SolveCompatibilityEq1d ( &r1u1, &r1s1, &q1v1, &b111, &c111 );
  SolveCompatibilityEq1d ( &q1v1, &q1t1, &r1u1, &f111, &g111 );
  b111 = f111 = 0.0;
          ...
          /* function values at (0,0) */
  SolveCompatibilityEq3d ( &r0u0, &r0s0, &r0uu0, &r0us0, &r0ss0, &q0vv0,
                           b010, c010, &b020, &c020 );
  SolveCompatibilityEq3d ( &q0v0, &q0t0, &q0vv0, &q0vt0, &q0tt0, &r0uu0,
                           f010, g010, &f020, &g020 );
          /* function values at (0,1) */
  SolveCompatibilityEq3d ( &r1u0, &r1s0, &r1uu0, &r1us0, &r1ss0, &q0vv1,
                           b110, c110, &b120, &c120 );
  SolveCompatibilityEq3d ( &q0v1, &q0t1, &q0vv1, &q0vt1, &q0tt1, &r1uu0,
                           f011, g011, &f021, &g021 );
  b120 = f021 = 0.0;
          /* function values at (1,0) */
  SolveCompatibilityEq3d ( &r0u1, &r0s1, &r0uu1, &r0us1, &r0ss1, &q1vv0,
                           b011, c011, &b021, &c021 );
  SolveCompatibilityEq3d ( &q1v0, &q1t0, &q1vv0, &q1vt0, &q1tt0, &r0uu1,
                           f110, g110, &f120, &g120 );
  b021 = f120 = 0.0;
          /* function values at (1,1) */
  SolveCompatibilityEq3d ( &r1u1, &r1s1, &r1uu1, &r1us1, &r1ss1, &q1vv1,
                           b111, c111, &b121, &c121 );
  SolveCompatibilityEq3d ( &q1v1, &q1t1, &q1vv1, &q1vt1, &q1tt1, &r1uu1,
                           f111, g111, &f121, &g121 );
  b121 = f121 = 0.0;
  ...
  SolveCompatibilityEq2ad (
        ...
        b010, c010, f010, g010, &b01d0, c01d0, &f01d0, g01d0 );
          ...
          /* hence their derivatives are the following: */
  b01d1 = (double)(2.0*(b011-b010)-b01d0);  b01dd0 = b01dd1 = b01d1-b01d0;
  f01d1 = (double)(2.0*(f011-f010)-f01d0);  f01dd0 = f01dd1 = f01d1-f01d0;
  ...
  SolveCompatibilityEq4bd (
          ...
          /* hence their derivatives are the following: */
  c02d1 = (double)(2.0*(c021-c020)-c02d0);  c02dd0 = c02dd1 = c02d1-c02d0;
  g02d1 = (double)(2.0*(g021-g020)-g02d0);  g02dd0 = g02dd1 = g02d1-g02d0;
  ...
  SolveCompatibilityEq5ad (
          ...
          /* hence their derivatives are the following: */
  b02d1  = (double)(3.0*(b021-b020)-2.0*b02d0-0.5*b02dd0);
  b02dd1 = (double)(6.0*(b021-b020-b02d0)-2.0*b02dd0);
  f02d1  = (double)(3.0*(f021-f020)-2.0*f02d0-0.5*f02dd0);
  f02dd1 = (double)(6.0*(f021-f020-f02d0)-2.0*f02dd0);
  ...
  SolveCompatibilityEq5bd (
    ...
    f12d0, &f12dd0, g120, g12d0, &g12dd0, b02d1, b02dd1, c021, c02d1, c02dd1 );
          ...
          /* hence their derivatives are the following: */
  c11d1  = (double)(3.0*(c111-c110)-2.0*c11d0-0.5*c11dd0);
  c11dd1 = (double)(6.0*(c111-c110-c11d0)-2.0*c11dd0);
  g11d1  = (double)(3.0*(g111-g110)-2.0*g11d0-0.5*g11dd0);
  g11dd1 = (double)(6.0*(g111-g110-g11d0)-2.0*g11dd0);
  ...
  b11dd1 = (double)(12.0*(b110-b111)+6.0*(b11d0+b11d1)+b11dd0);
  f11dd1 = (double)(12.0*(f110-f111)+6.0*(f11d0+f11d1)+f11dd0);
  ...
  SolveCompatibilityEq4bd (
          ...
          /* hence their second order derivatives at 1 are the following: */
  c12dd1 = (double)(12.0*(c120-c121)+6.0*(c12d0+c12d1)+c12dd0);
  g12dd1 = (double)(12.0*(g120-g121)+6.0*(g12d0+g12d1)+g12dd0);
  ...
  b01[0] = b010;  b01[1] = (double)(b010+0.5*b01d0);  b01[2] = b011;
  c01[0] = c010;  c01[1] = c011;
  f01[0] = f010;  f01[1] = (double)(f010+0.5*f01d0);  f01[2] = f011;
  g01[0] = g010;  g01[1] = g011;
  b11[0] = b110;  b11[1] = (double)(b110+0.25*b11d0);
  b11[2] = (double)(b110+0.5*b11d0+b11dd0/12.0);
  b11[3] = (double)(b111-0.25*b11d1);  b11[4] = b111;
  c11[0] = c110;  c11[1] = (double)(c110+c11d0/3.0);
  c11[2] = (double)(c111-c11d1/3.0);   c11[3] = c111;
  f11[0] = f110;  f11[1] = (double)(f110+0.25*f11d0);
  f11[2] = (double)(f110+0.5*f11d0+f11dd0/12.0);
  f11[3] = (double)(f111-0.25*f11d1);  f11[4] = f111;
  g11[0] = g110;  g11[1] = (double)(g110+g11d0/3.0);
  g11[2] = (double)(g111-g11d1/3.0);   g11[3] = g111;

  b02[0] = b020;  b02[1] = (double)(b020+b02d0/3.0);
  b02[2] = (double)(b021-b02d1/3.0);  b02[3] = b021;
  c02[0] = c020;  c02[1] = (double)(c020+0.5*c02d0);  c02[2] = c021;
  f02[0] = f020;  f02[1] = (double)(f020+f02d0/3.0);
  f02[2] = (double)(f021-f02d1/3.0);  f02[3] = f021;
  g02[0] = g020;  g02[1] = (double)(g020+0.5*g02d0);  g02[2] = g021;
  b12[0] = b120;  b12[1] = (double)(b120+0.2*b12d0);
  b12[2] = (double)(b120+0.4*b12d0+0.05*b12dd0);
  b12[3] = (double)(b121-0.4*b12d1+0.05*b12dd1);
  b12[4] = (double)(b121-0.2*b12d1);  b12[5] = b121;
  c12[0] = c120;  c12[1] = (double)(c120+0.25*c12d0);
  c12[2] = (double)(c120+0.5*c12d0+c12dd0/12.0);
  c12[3] = (double)(c121-0.25*c12d1);  c12[4] = c121;
  f12[0] = f120;  f12[1] = (double)(f120+0.2*f12d0);
  f12[2] = (double)(f120+0.4*f12d0+0.05*f12dd0);
  f12[3] = (double)(f121-0.4*f12d1+0.05*f12dd1);
  f12[4] = (double)(f121-0.2*f12d1);  f12[5] = f121;
  g12[0] = g120;  g12[1] = (double)(g120+0.25*g12d0);
  g12[2] = (double)(g120+0.5*g12d0+g12dd0/12.0);
  g12[3] = (double)(g121-0.25*g12d1);  g12[4] = g121;
/*
...
static boolean MultJFunctionsd ( int hole_k,
               ...
               double *b11b11, double *twob11c11, double *c11c11 )
{
...
static boolean FindJFunctionsd ( GHoleDomaind *domain )
{
  ...
  int      hole_k;
  int      i, j;
  vector2d *omcbc, *omcbcd, *omcbcdd, *surrpcbc;
  ...
  privateG2->jfunc = malloc ( hole_k*(28+i)*sizeof(double) );
  if ( !privateG2->jfunc ) {
  ...
  if ( !_g2h_VerifyJunctionFunctionsd ( domain ) ) {
