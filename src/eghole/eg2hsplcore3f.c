                                   ...
                                   const float *cp, void *usrptr ) )
{
  ...
  for ( i = 0;  i < hole_k;  i++ ) {
    ...
    mbs_multiSubtractBSCurvesf ( 1, spdimen, G2_CROSS00DEG, 2*G2_CROSS00DEG+1,
    ...
    mbs_multiSubtractBSCurvesf ( 1, spdimen, G2_CROSS01DEG, 2*G2_CROSS01DEG+1,
    ...
    mbs_multiSubtractBSCurvesf ( 1, spdimen, G2_CROSS02DEG, 2*G2_CROSS02DEG+1,
