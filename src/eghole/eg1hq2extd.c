...
/* !!! this is not as it ought to be!, to be replaced later !!! */
  if ( fi == 2 ) {
    for ( i = j = 0;  i < nkn;  i++, j += 5 ) {
      mbs_BCHornerDer2Pd ( G1H_FINALDEG, G1H_FINALDEG, 1, b, 0.0, tkn[i],
                           &p, &pu, &pv, &puu, &puv, &pvv );
  ...
  if ( fi == G1H_FINALDEG-2 ) {
    for ( i = j = 0;  i < nkn;  i++, j += 5 ) {
      mbs_BCHornerDer2Pd ( G1H_FINALDEG, G1H_FINALDEG, 1, b, 1.0, tkn[i],
                           &p, &pu, &pv, &puu, &puv, &pvv );
  ...
  if ( fj == 2 ) {
    for ( i = j = 0;  i < nkn;  i++, j += 5 ) {
      mbs_BCHornerDer2Pd ( G1H_FINALDEG, G1H_FINALDEG, 1, b, tkn[i], 0.0,
                           &p, &pu, &pv, &puu, &puv, &pvv );
  ...
  if ( fj == G1H_FINALDEG-2 ) {
    for ( i = j = 0;  i < nkn;  i++, j += 5 ) {
      mbs_BCHornerDer2Pd ( G1H_FINALDEG, G1H_FINALDEG, 1, b, tkn[i], 1.0,
                           &p, &pu, &pv, &puu, &puv, &pvv );
