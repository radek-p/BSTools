                                              ...
                                              G1HNLSPrivated *nlspr )
{
  ...
  mbs_TabCubicHFuncDer2d ( 0.0, 1.0, nkn, tkn, hfunc, dhfunc, ddhfunc );
      ...
      for ( k = 0;  k < rr;  k++, fn++ ) {
        ...
        for ( ik = i0, sn = 0;  ik <= i1;  ik++ ) {
          ...
          for ( jk = j0, dn = ik*nkn+j0;
            ...
            pkn_Comp2iDerivatives2d ( diu[dn].x, diu[dn].y, div[dn].x, div[dn].y,
...
/* ////////////////////////////////////////////////////////////////////////// */
#ifdef DEBUG_HESSIAN
void _TestHessian ( GHoleDomaind *domain, G1HNLSPrivated *nlsprivate )
{
  void  *sp;
