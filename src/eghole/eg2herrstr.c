...
case G2H_ERROR_NO_SCRATCH_MEMORY:
    return "Not enough scratch memory";

case G2H_ERROR_CANNOT_MALLOC:
    return "Cannot malloc";

case G2H_ERROR_INVALID_OPTION:
    return "Invalid option";

case G2H_ERROR_INVALID_PARTITION:
    return "Invalid partition";

case G2H_ERROR_INVALID_JUNC_FUNC:
    return "Invalid junction functions";

case G2H_ERROR_NONPOSITIVE_MATRIX:
    return "System matrix not positive-definite";

case G2H_ERROR_NONPOSITIVE_EXT_MATRIX:
    return "Extended system matrix not positive-definite";

case G2H_ERROR_UNDEFINED_CONSTR:
    return "Undefined constraints";

case G2H_ERROR_INCONSISTENT_CONSTR:
    return "Inconsistent constraints";

case G2H_ERROR_NL_CANNOT_PROJECT:
    return "NL: Cannot project this surface";

case G2H_ERROR_NL_JACOBIAN:
    return "NL: Jacobian has various signs";

case G2H_ERROR_NL_MINIMIZATION:
    return "NL: Cannot find the minimum";

case G2H_ERROR_SPLINE_BASIS_NOT_READY:
