               ...
               float *pv, float *pvv )
{
  ...
  mbs_multiMultBezCf ( 1, G2_BF01DEG, 0, b1, spdimen, 1, G2_CROSS00DEG-1, 0, r0u,
                       &deg1, 0, aux1 );
  mbs_multiMultBezCf ( 1, G2_CG01DEG, 0, c1, spdimen, 1, G2_CROSS00DEG-1, 0, r0s,
                       &deg2, 0, aux2 );
  ...
  mbs_multiMultBezCf ( 1, G2_BF02DEG, 0, b2, spdimen, 1, G2_CROSS00DEG-1, 0, r0u,
                       &deg1, 0, aux1 );
  mbs_multiMultBezCf ( 1, G2_CG02DEG, 0, c2, spdimen, 1, G2_CROSS00DEG-1, 0, r0s,
                       &deg2, 0, aux2 );
  ...
  mbs_multiMultBezCf ( 1, 2*G2_BF01DEG, 0, b1b1, spdimen, 1, G2_CROSS00DEG-2, 0,
                       r0uu, &deg1, 0, aux1 );
  mbs_multiMultBezCf ( 1, G2_BF01DEG+G2_CG01DEG, 0, twob1c1, spdimen, 1, G2_CROSS00DEG-2, 0,
                       r0us, &deg2, 0, aux2 );
            /* at this point deg1 = 9, deg2 = 8 */
  mbs_multiBCDegElevf ( 1, spdimen, 0, deg2, aux2, deg1-deg2, 0, &deg2, aux3 );
  pkn_AddMatrixf ( 1, spdimen*(deg1+1), 0, aux1, 0, aux3, 0, aux1 );
  mbs_multiMultBezCf ( 1, 2*G2_CG01DEG, 0, c1c1, spdimen, 1, G2_CROSS00DEG-2, 0,
                       r0ss, &deg2, 0, aux2 );
               ...
               float *pv, float *pvv )
{
  ...
  mbs_multiFindBezDerivativef ( 3, 1, spdimen, 0, r0s, 0, r0us );
        ...
        /* compute pv = b1*ru + c1*rs */
  mbs_multiMultBezCf ( 1, G2_BF11DEG, 0, b1, spdimen, 1, 2, 0, r0u,
                       &deg1, 0, aux1 );
  mbs_multiMultBezCf ( 1, G2_CG11DEG, 0, c1, spdimen, 1, 3, 0, r0s,
                       &deg2, 0, aux2 );
  ...
  pkn_AddMatrixf ( 1, spdimen*(deg1+1), 0, aux1, 0, aux2, 0, pv );
        ...
        /* compute pvv = b2*ru + c2*rs + b1^2ruu + 2*b1*c1*rus + c1^2*rss */
  mbs_multiMultBezCf ( 1, G2_BF12DEG, 0, b2, spdimen, 1, 2, 0, r0u,
                       &deg1, 0, aux1 );
  mbs_multiMultBezCf ( 1, G2_CG12DEG, 0, c2, spdimen, 1, 3, 0, r0s,
                       &deg2, 0, aux2 );
  ...
  mbs_multiMultBezCf ( 1, 2*G2_BF11DEG, 0, b1b1, spdimen, 1, 1, 0,
                       r0uu, &deg1, 0, aux1 );
  mbs_multiMultBezCf ( 1, G2_BF11DEG+G2_CG11DEG, 0, twob1c1, spdimen, 1, 2, 0,
                       r0us, &deg2, 0, aux2 );
            /* at this point deg1 = deg2 = 9 = G2_CROSS12DEG */
  pkn_AddMatrixf ( 1, spdimen*(deg1+1), 0, aux1, 0, aux2, 0, aux1 );
  mbs_multiMultBezCf ( 1, 2*G2_CG11DEG, 0, c1c1, spdimen, 1, 3, 0,
                       r0ss, &deg2, 0, aux2 );
            /* at this point deg1 = deg2 = 9 = G2_CROSS12DEG */
  pkn_AddMatrixf ( 1, spdimen*(deg1+1), 0, aux1, 0, aux2, 0, aux1 );
