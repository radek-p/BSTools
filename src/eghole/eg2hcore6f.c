               ...
               float *pv, float *pvv )
{
  ...
  if ( !mbs_multiBCDegElevf ( 1, spdimen, 0, deg2, aux2, deg1-deg2, 0, &deg2, pv ) )
    goto failure;
  ...
  if ( !mbs_multiBCDegElevf ( 1, spdimen, 0, deg2, aux2, deg1-deg2, 0, &deg2, pvv ) )
    goto failure;
  ...
  if ( !mbs_multiMultBezCf ( 1, G2_BF01DEG+G2_CG01DEG, 0, twob1c1, spdimen, 1, G2_CROSS00DEG-2, 0,
    ...
    goto failure;
            /* at this point deg1 = 9, deg2 = 8 */
  if ( !mbs_multiBCDegElevf ( 1, spdimen, 0, deg2, aux2, deg1-deg2, 0, &deg2, aux3 ) )
    goto failure;
               ...
               float *pv, float *pvv )
{
  ...
  if ( !mbs_multiBCDegElevf ( 1, spdimen, 0, deg1, aux3, G2_CROSS12DEG-deg1,
                              0, &deg1, pvv ) )
    goto failure;
