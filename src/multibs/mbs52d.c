          ...
          double *pcorners )
{
  ...
  if ( mbs_multideBoorDerd ( degc00, lastknotc00, knotsc00, 1, spdimen, 0, c00, u0,
      &pcorners[0], &pcorners[spdimen*8] ) < 0 )
    goto failure;
  if ( mbs_multideBoorDerd ( degc00, lastknotc00, knotsc00, 1, spdimen, 0, c00, u1,
      &pcorners[spdimen*4], &pcorners[spdimen*12] ) < 0 )
    goto failure;
  if ( mbs_multideBoorDerd ( degc10, lastknotc10, knotsc10, 1, spdimen, 0, c10, u0,
      &pcorners[spdimen*1], &pcorners[spdimen*9] ) < 0 )
    goto failure;
  if ( mbs_multideBoorDerd ( degc10, lastknotc10, knotsc10, 1, spdimen, 0, c10, u1,
      &pcorners[spdimen*5], &pcorners[spdimen*13] ) < 0 )
    goto failure;
  if ( mbs_multideBoorDerd ( degc01, lastknotc01, knotsc01, 1, spdimen, 0, c01, u0,
      &pcorners[spdimen*2], &pcorners[spdimen*10] ) < 0 )
    goto failure;
  if ( mbs_multideBoorDerd ( degc01, lastknotc01, knotsc01, 1, spdimen, 0, c01, u1,
      &pcorners[spdimen*6], &pcorners[spdimen*14] ) < 0 )
    goto failure;
  if ( mbs_multideBoorDerd ( degc11, lastknotc11, knotsc11, 1, spdimen, 0, c11, u0,
      &pcorners[spdimen*3], &pcorners[spdimen*11] ) < 0 )
    goto failure;
  if ( mbs_multideBoorDerd ( degc11, lastknotc11, knotsc11, 1, spdimen, 0, c11, u1,
      ...
      int *degreev, int *lastvknot, double *vknots, double *p )
{
  ...
  *lastvknot = lastvkn;
  ...
  if ( !mbs_multiInterp2knHermiteBSd ( 1, ptch, 3, 7, avknots, 2, auxptch, _cd00,
  ...
  if ( !mbs_multiInterp2knHermiteBSd ( 1, ptch, 3, 7, auknots, 2, auxptch, _cd00,
  ...
  if ( !mbs_BSC1CoonsFindCornersd ( spdimen,
  ...
  if ( !mbs_multiInterp2knHermiteBSd ( 1, 4*spdimen, 3, 7, auknots, 2, 0, bc,
                                 2, 0, &bc[4*2*spdimen], 0, p1 ) )
    goto failure;
  if ( !mbs_multiInterp2knHermiteBSd ( 4, spdimen, 3, 7, avknots, 2, 4*spdimen, p1,
