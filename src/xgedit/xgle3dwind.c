...
/* ///////////////////////////////////////////////////////////////////////// */
static void xgle_3DwindDrawXYZ ( CameraRecd *CPos, char cc, char left,
...
case 0:
  ...
  case 0:
      ...
      xgle_3DwindDrawXYZ ( &_3Dwin->CPos[id], 2, 1, x, y, p.z );
      if ( zoomwin == 0 )
        xgle_3DwindDrawXYZ ( &_3Dwin->CPos[id], 0, 0, x, y, p.x );
      break;
  case 1:   
      xgleDrawLine ( _3Dwin->CPos[id].xmin, y,
                     _3Dwin->CPos[id].xmin+_3Dwin->CPos[id].width, y );
...
case 1:   
  ...
  case 1:   
      ...
      SetPoint3d ( &q, (double)x, (double)y, 0.0 );
      CameraUnProjectPoint3d ( &_3Dwin->CPos[id], &q, &p );
      xgle_3DwindDrawXYZ ( &_3Dwin->CPos[id], 1, 0, x, y, p.y );
      if ( zoomwin == 1 )
        xgle_3DwindDrawXYZ ( &_3Dwin->CPos[id], 2, 1, x, y, p.z );
      break;
  case 2:   
...
case 2:   
  ...
  case 2:   
      ...
      SetPoint3d ( &q, (double)x, (double)y, 0.0 );
      CameraUnProjectPoint3d ( &_3Dwin->CPos[id], &q, &p );
      xgle_3DwindDrawXYZ ( &_3Dwin->CPos[id], 1, 1, x, y, p.y );
      xgle_3DwindDrawXYZ ( &_3Dwin->CPos[id], 0, 0, x, y, p.x );
      break;
    }
    break;
  }
} /*xgle_3DwindDrawCursorPos*/
